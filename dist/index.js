...
function findContainer(manifest, containerName) {
    var _a, _b, _c;
    const images = (_c = (_b = (_a = manifest === null || manifest === void 0 ? void 0 : manifest.spec) === null || _a === void 0 ? void 0 : _a.template) === null || _b === void 0 ? void 0 : _b.spec) === null || _c === void 0 ? void 0 : _c.containers;
    if (images === undefined) {
    ...
    const matches = images.filter((imageSpec) => imageSpec.name === containerName);
    if (matches.length !== 1) {
        throw new Error(`Expected 1 image with name "${containerName}" but found ${matches.length}`);
    }
    return matches[0];
}
function updateImage(manifestContent, containerName, newTag) {
